...
struct result {
    ...
    char protocol_downgrade; // test connect_error 0 0 0 0 protocol_downgrade fallback_scsv
    char ocsp_stapling; // test connect_error 0 0 0 0 ocsp_resp_error support
